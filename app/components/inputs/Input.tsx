  ...
  return (
    <div className="w-full relative">
      <input
       ...
       border-2 rounded-2 transition disabled:opacity-70 disabled:cursor-not-allowed
      ...
      transform -translate-y-3 top-5 origin-[0] z-10 left-4 peer-placeholder-shown:scale-100
